    ...
    public static int getStudents(List<Student> students, int pageNo, int page_size) {
        ...
        try {
            ...
            while (rs.next()) {
                ...
                s.setName(rs.getString("name")==null?"":rs.getString("name"));
                s.setStudentNumber(rs.getString("studentnumber"));
                s.setDepartment(rs.getString("department")==null?"":rs.getString("department"));
                s.setClasses(rs.getString("class")==null?"":rs.getString("class"));
                s.setDormNumber(rs.getString("dormnumber")==null?"":rs.getString("dormnumber"));
                s.setStudentPhone(rs.getString("myphone"));
                s.setParentPhone(rs.getString("parentphone")==null?"":rs.getString("parentphone"));
                s.setSex(Enum.valueOf(Sex.class,rs.getString("sex") == null ? "未知" : rs.getString("sex")));
