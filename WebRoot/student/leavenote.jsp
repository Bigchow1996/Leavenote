	...
	<div class="heading">请填写假条信息</div>
		<form>
			...
			<div class="form-group col-md-8">
				<input type="text" id="btime" name="btime"  style="cursor:pointer" placeholder="请输入请假开始时间" class="form-control"  />
			</div>
			...
			<div class="form-group col-md-8">
				<input type="text" id="etime" name="etime" style="cursor:pointer" placeholder="请输入请假结束时间" class="form-control" />
			</div>
			<div class="form-group col-md-4">
			...
			<div class="form-group col-md-12">
			    ...
			    <textarea class="form-control" maxlength="25" placeholder="不得超过25字" rows="3" id="reason" name="reason"></textarea>
			</div>
