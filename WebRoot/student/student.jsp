...
<html>
	...
	<link rel="shortcut icon" type="image/x-icon" href="images/favicon.ico" media="screen" />
		...
		<script>
			...
			function leavenote(name,department,classes,parentPhone,dormNumber )
			{

				
				if(dormNumber==null || dormNumber == "" || parentPhone==""||parentPhone==null||classes ==""||classes==null||department ==""||department==null||name ==""||name==null){
					alert("请完善好信息再来！");
			...
			<hr style="border:0;background-color:gray;height:1px;" />
			 <div >
				<form style="margin-left:10px;margin-right:10px;">
				    <div align="center">
				          <input type="button" value="我要请假" class="btn btn-default" style="width:200px;background:#1E90FF" onclick="leavenote('${student.name }','${student.department }','${student.classes }','${student.parentPhone }','${student.dormNumber }')"/><br><br>
