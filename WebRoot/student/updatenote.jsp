		...
		<form>
			...
			<div class="form-group col-md-4">
				<select class="form-group selectpicker" id="eclass" name="eclass" >
					    <option value="1" ${eclass == 1 ? 'selected' : '' }>第1节</option>
					    <option value="2" ${eclass == 2 ? 'selected' : '' }>第2节</option>
					    <option value="3" ${eclass == 3 ? 'selected' : '' }>第3节</option>
					    <option value="4" ${eclass == 4 ? 'selected' : '' }>第4节</option>
					    <option value="5" ${eclass == 5 ? 'selected' : '' }>第5节</option>
					    <option value="6" ${eclass == 6 ? 'selected' : '' }>第6节</option>
					    <option value="7" ${eclass == 7 ? 'selected' : '' }>第7节</option>
					    <option value="8" ${eclass == 8 ? 'selected' : '' }>第8节</option>
					    <option value="9" ${eclass == 9 ? 'selected' : '' }>第9节</option>
					    <option value="10" ${eclass == 10 ? 'selected' : '' }>第10节</option>
					    <option value="11" ${eclass == 11 ? 'selected' : '' }>第11节</option>                               
					</select>
			</div>
			<div class="form-group col-md-12">
